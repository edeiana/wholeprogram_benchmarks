...
#endif
// START FOR
//#pragma omp parallel for default(shared) schedule(dynamic, blocksize) private(tmpsd, yi, dij3i, daix, daiw, sumda, dij1i, k, xij, ri1i, datmp, yij, dumbo, i34, sj, r2, temp1, daiz, dij, zi, j34, dij2i, sj2, daiy, j, npairs, ri, zij, daiw, temp1) // ED
